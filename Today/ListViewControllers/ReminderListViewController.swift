...
class ReminderListViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        let headerRegistration = UICollectionView.SupplementaryRegistration(elementKind: ProgressHeaderView.elemendKind, handler: supplementaryRegistrationHandler)
    ...
    override func collectionView(_ collectionView: UICollectionView, willDisplaySupplementaryView view: UICollectionReusableView, forElementKind elementKind: String, at indexPath: IndexPath) {
        guard elementKind == ProgressHeaderView.elemendKind, let progressView = view as? ProgressHeaderView else { return }
